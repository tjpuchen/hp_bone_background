   ...
   <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                  	<span class="text-muted text-xs block">欢迎来到惠普骨科,陈先生</span>
             	</li>
             	<li class="dropdown">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">  
                    	...
                    	<div class="row">
                    		<div class="col-sm-2">                    			                    		
	                        	<h5>关节状态图 <small></small></h5>
	                        </div>
	                        <div class="col-sm-3"> 
		                        <select name="status" id="status" class="form-control">
		                                <option value="0" selected>第一次状态数据录入</option>
		                                <option value="1">第二次状态数据录入</option>
		                                <option value="2" >第三次状态数据录入</option>		                  
		                        </select> 
		                    </div>    
		                    <div class="col-sm-7"> 
                            ...
                            <div class="flot-chart">
                                ...
                                <script type="text/javascript">
							        ...
							        var option = {							        	
							            ...
							            tooltip: {},
							            legend: {
							                data:['左肘','右肘','左膝','右膝','左踝','右踝']							     							                							             
							            },
							            xAxis: {							           
							                data: ['肿胀',"肌肉萎缩","关节疼","肌力","总体步态"]
                            ...
                            <div class="flot-chart-content" id="main2"></div>
                                <script type="text/javascript">
							        ...
							        option = {
											    ...
											    legend: {
											        data:['第一次状态信息录入','第二次状态信息录入','第三次状态信息录入']
											    },
											    grid: {
											        left: '3%',
											        right: '4%',
