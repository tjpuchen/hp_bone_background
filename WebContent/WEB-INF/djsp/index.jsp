                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                    	...
                    	<ul class="nav nav-second-level collapse">
                         <li class="active" ><a href="<%=path%>/index.jsp"> <span class="nav-label">全部患者信息</span></a></li>
             	...
             	<li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="<%=path%>/8-1.jsp">
                                <div>
                                    <i class="fa fa-envelope fa-fw"></i> 您有 16 条留言 通知
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15" data-filter=#filter>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <button class="btn-white btn btn-xs" onclick="window.location.href='<%=path%>/1-1-2.jsp'">制定诊疗计划</button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                               ...
                               <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <button class="btn-white btn btn-xs" onclick="window.location.href='1-1-2.jsp'">制定诊疗计划</button>
                                            <!--<button class="btn-white btn btn-xs">修改</button>
                                            <button class="btn-white btn btn-xs">删除</button>-->
                                        </div>
                                    </td>
